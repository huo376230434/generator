...
class DwMakeModel extends DwMakeBase
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dm:model  {model} {--m} {--fields=} {--remove} ';
...
//        dd($this->getModelArr());
    ...
    protected function getTasks()
    {
        $tasks = [
            ...
            [
                ...
                'des_path' => $this->model_dir.'ZZ'.$this->model_name."RelationTrait.php"],//
            [
                'stub_path' =>$this->stub_dir.'model_static_trait.stub.php',
                'des_path' => $this->model_dir.'ZZ'.$this->model_name."StaticTrait.php"],//
        ];
        return $tasks;
    ...
    {
        $shell = " php  ".base_path('artisan').' dm:migration '.Str::plural(Str::snake($model_name));
